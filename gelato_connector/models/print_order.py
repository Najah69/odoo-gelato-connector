...
class GelPrintOrder(models.Model):
    ...
    image_url = fields.Char(
        string='Image URL', required=True,
    ...
    gelato_order_id = fields.Many2one(
        'gelato.order', string='Gelato Order', readonly=True, ondelete='set null',
    )
    ...
    def _auto_create_sale_order(self):
        ...
        so = self.env['sale.order'].create({
            ...
            'order_line': [(0, 0, {
                ...
                'tax_id': [(6, 0, product.taxes_id.filtered(
